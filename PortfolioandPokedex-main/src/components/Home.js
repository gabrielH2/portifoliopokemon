    ...
    return (
        <Container>
            ...
            <Row style={{ border: '1px solid none', display: 'flex', justifyContent: 'flex-start' }}>
                <Col style={{ border: '1px solid none' }}><a href='https://www.instagram.com/gabr1el_m4chad0/'><img src={ig} alt='' width='70px' /></a></Col>
                <Col style={{ border: '1px solid none' }}><Link to='/pokedex'><img src={pd} alt='' width='100px' style={{ position: 'relative', bottom: '10px' }} /></Link></Col>
                <Col style={{ border: '1px solid none' }}><a href='https://github.com/gabrielH2'><img src={git} alt='' width='70px' /></a></Col>
            </Row>
